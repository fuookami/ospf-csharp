...
public class TrivalentTest {
    ...
    public void True_And_True_Is_True() {
        Trivalent result = new Trivalent.True().And(new Trivalent.True());
    ...
    public void True_And_False_Is_False() {
        Trivalent result = new Trivalent.True().And(new Trivalent.False());
    ...
    public void True_And_Unknown_Is_Unknown() {
        Trivalent result = new Trivalent.True().And(new Trivalent.Unknown());
    ...
    public void False_Or_False_Is_False() {
        Trivalent result = new Trivalent.False().Or(new Trivalent.False());
        Assert.IsType<Trivalent.False>(result);
    }

    [Fact]
    public void False_Or_Unknown_Is_Unknown() {
        Trivalent result = new Trivalent.False().Or(new Trivalent.Unknown());
        Assert.IsType<Trivalent.Unknown>(result);
    }

    [Fact]
    public void Not_True_Is_False() {
        Trivalent result = new Trivalent.True().Not();
        Assert.IsType<Trivalent.False>(result);
    }

    [Fact]
    public void Not_False_Is_True() {
        Trivalent result = new Trivalent.False().Not();
        Assert.IsType<Trivalent.True>(result);
    }

    [Fact]
    public void Not_Unknown_Is_Unknown() {
        Trivalent result = new Trivalent.Unknown().Not();
        Assert.IsType<Trivalent.Unknown>(result);
    }

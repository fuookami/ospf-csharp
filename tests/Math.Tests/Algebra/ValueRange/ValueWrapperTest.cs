...
namespace Fuookami.Ospf.Math.Tests.Algebra.ValueRange
{
    public class ValueWrapperTest
    {
        ...
        {
            var c = NumericConstantsRegistry.For<Flt64>();
            var result = ValueWrapper<Flt64>.Of(c.PositiveInfinity!.Value);
        ...
        {
            var c = NumericConstantsRegistry.For<Flt64>();
            var result = ValueWrapper<Flt64>.Of(c.NegativeInfinity!.Value);
            Assert.True(result.IsOk);
        ...
        {
            var c = NumericConstantsRegistry.For<Flt64>();
            var result = ValueWrapper<Flt64>.Of(c.NaN!.Value);
        ...
        {
            var result = ValueWrapper<Flt64>.Of(new Flt64(42.0));
            Assert.True(result.IsOk);

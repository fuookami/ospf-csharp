...
public class NumericConstantsRegistryTest {
    ...
    public void Registry_ForUInt64_ReturnsCorrectConstants() {
        // Act
        INumericConstants<UInt64> constants = NumericConstantsRegistry.For<UInt64>();
    ...
    public void Registry_ForFlt32_ReturnsCorrectConstants() {
        // Act
        INumericConstants<Flt32> constants = NumericConstantsRegistry.For<Flt32>();
    ...
    public void Registry_ForFltX_ReturnsCorrectConstants() {
        // Act
        INumericConstants<FltX> constants = NumericConstantsRegistry.For<FltX>();
    ...
    public void Registry_ForOrNull_ReturnsNullForUnregisteredTypes() {
        ...
        INumericConstants<Flt64>? result = NumericConstantsRegistry.ForOrNull<Flt64>();

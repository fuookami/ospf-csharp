...
public class ExpressionRangeTests {
    ...
    public void Create_WithRange_UsesRegistryConstants() {
        ValueRange<Flt64> valueRange = Fuookami.Ospf.Math.Algebra.ValueRange.ValueRange<Flt64>.Of(
    ...
    public void IntersectWith_TightensRange() {
        var range = ExpressionRange<Flt64>.Create();
        ValueRange<Flt64> ub = Fuookami.Ospf.Math.Algebra.ValueRange.ValueRange<Flt64>.Leq(new Flt64(5)).Value!;
    ...
    public void IntersectWith_EmptyResult_ReturnsFalse() {
        ...
        ValueRange<Flt64> ub = Fuookami.Ospf.Math.Algebra.ValueRange.ValueRange<Flt64>.Leq(new Flt64(3)).Value!;
        range.IntersectWith(ub);

        // Then try to set lower bound to 5 (should make empty)
        ValueRange<Flt64> lb = Fuookami.Ospf.Math.Algebra.ValueRange.ValueRange<Flt64>.Geq(new Flt64(5)).Value!;
    ...
    public void SetRange_OverwritesRange() {
        var range = ExpressionRange<Flt64>.Create();
        ValueRange<Flt64> newRange = Fuookami.Ospf.Math.Algebra.ValueRange.ValueRange<Flt64>.Of(
    ...
    public void ToString_EmptyRange_ReturnsEmpty() {
        ...
        ValueRange<Flt64> ub = Fuookami.Ospf.Math.Algebra.ValueRange.ValueRange<Flt64>.Leq(new Flt64(0)).Value!;
        range.IntersectWith(ub);
        ValueRange<Flt64> lb = Fuookami.Ospf.Math.Algebra.ValueRange.ValueRange<Flt64>.Geq(new Flt64(10)).Value!;

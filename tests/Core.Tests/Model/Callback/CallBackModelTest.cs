...
public class CallBackModelTest {
    ...
    public void CallBackModel_AddConstraint_ShouldSucceed() {
        ...
        Result<Success, ErrorCode, Error<ErrorCode>> result = model.AddConstraint(solution => true, "c1");
    ...
    public void CallBackModel_Minimize_ShouldSucceed() {
        ...
        Result<Success, ErrorCode, Error<ErrorCode>> result = model.Minimize(solution => Flt64.One, "obj1");
    ...
    public void CallBackModel_Maximize_ShouldSucceed() {
        ...
        Result<Success, ErrorCode, Error<ErrorCode>> result = model.Maximize(solution => Flt64.One, "obj1");
    ...
    public void CallBackModel_ConstraintSatisfied_WithNoViolations_ShouldReturnTrue() {
        ...
        bool? result = model.ConstraintSatisfied(new List<Flt64> { Flt64.One });

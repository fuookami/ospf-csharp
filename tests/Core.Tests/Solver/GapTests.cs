...
public class GapTests {
    ...
    [Fact]
    public void Compute_BothZero_ShouldReturnZero() => Gap.Compute(Flt64.Zero, Flt64.Zero).Should().Be(Flt64.Zero);

    [Fact]
    public void Compute_DifferentValues_ShouldReturnPositiveGap() {
        var obj = new Flt64(100.0);
        var best = new Flt64(90.0);
        Flt64 gap = Gap.Compute(obj, best);
    ...
    public void Compute_DifferentValues_ShouldBeSymmetric() {
        ...
        Flt64 gap1 = Gap.Compute(a, b);
        Flt64 gap2 = Gap.Compute(b, a);
        gap1.Should().Be(gap2);
    }
    ...
    public void Compute_OneZero_ShouldWork() {
        ...
        Flt64 gap = Gap.Compute(Flt64.Zero, new Flt64(100.0));

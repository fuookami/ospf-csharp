...
public class IntoValueTests {
    ...
    public void Identity_ConvertFlt64ToFlt64_ShouldReturnSameValue() {
        IIntoValue<Flt64> converter = IIntoValue<Flt64>.Identity;
    ...
    public void Identity_RoundTrip_ShouldBeIdempotent() {
        ...
        Flt64 converted = converter.IntoValue(original);
        Flt64 backConverted = converter.FromValue(converted);
    ...
    public void Flt64ToInt64_Converter_ShouldWork() {
        ...
        Int64 int64Value = converter.IntoValue(flt64Value);
    ...
    public void Flt64ToInt64_Converter_FromValue_ShouldConvertBack() {
        ...
        Flt64 flt64Value = converter.FromValue(int64Value);
    ...
    public void Flt64ToInt64_Converter_RoundTrip() {
        ...
        Flt64 flt64 = converter.FromValue(original);
        Int64 backConverted = converter.IntoValue(flt64);
        backConverted.Should().Be(original);
    }

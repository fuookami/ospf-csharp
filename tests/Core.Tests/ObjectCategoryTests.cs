...
public class ObjectCategoryTests {
    [Fact]
    public void Maximum_Reverse_IsMinimum() => ObjectCategory.Maximum.Reverse().Should().Be(ObjectCategory.Minimum);

    [Fact]
    public void Minimum_Reverse_IsMaximum() => ObjectCategory.Minimum.Reverse().Should().Be(ObjectCategory.Maximum);

...
public class RectangularPackingDemandTest {
    ...
    public void SceneShouldExposeRealPlacementOverlapNeed() {
        ...
        Box2Need<FltX>? overlap = placementA.ToBox2Need().Intersect(placementB.ToBox2Need());
    ...
    public void GeometryMappingShouldMatchNeedIntersectionContract() {
        ...
        Box2Need<FltX>? needIntersection = placementA.ToBox2Need().Intersect(placementB.ToBox2Need());
        Assert.NotNull(needIntersection);

        QuantityPlacement2<FltX> geometryIntersection = placementA
            .ToPlacement2Need()

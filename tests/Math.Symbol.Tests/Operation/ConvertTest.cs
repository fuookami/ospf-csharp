...
public class ConvertTest {
    ...
    public void QuadraticMonomial_TryToLinearMonomial_Linear() {
        ...
        Result<LinearMonomial<Flt64>, ErrorCode, Error<ErrorCode>> result = qm.TryToLinearMonomial();
    ...
    public void QuadraticPolynomial_TryToLinearPolynomial() {
        var qp = new QuadraticPolynomial<Flt64>(
            ...
            new Flt64(3.0));
        Result<LinearPolynomial<Flt64>, ErrorCode, Error<ErrorCode>> result = qp.TryToLinearPolynomial();
        result.IsOk.Should().BeTrue();
    ...
    public void CanonicalPolynomial_TryToLinearPolynomial_FailsForQuadratic() {
        var cp = new CanonicalPolynomial<Flt64>(
            ...
            Flt64.Zero);
        Result<LinearPolynomial<Flt64>, ErrorCode, Error<ErrorCode>> result = cp.TryToLinearPolynomial();
        result.IsFailed.Should().BeTrue();
    }

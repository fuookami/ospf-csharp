...
public class LexerTests {
    ...
    public void TokenizeSimple_shouldProduceTokens() {
        IReadOnlyList<Token> tokens = "age > 18".Tokenize();
    ...
    public void TokenizePath_shouldProduceSingleIdentifier() {
        IReadOnlyList<Token> tokens = "user.address.city = 'NYC'".Tokenize();
        Assert.Equal(TokenType.Identifier, tokens[0].Type);
    ...
    public void TokenizeKeywords_shouldRecognizeAll() {
        IReadOnlyList<Token> tokens = "and or not in is like".Tokenize();
...
public class ParserTests {
    ...
    public void ParseSimpleComparison_shouldWork() {
        Result<BooleanExpression, ErrorCode, Error<ErrorCode>> result = BooleanExpressionParser.Parse("age > 18");
    ...
    public void ParseStringComparison_shouldWork() {
        Result<BooleanExpression, ErrorCode, Error<ErrorCode>> result = BooleanExpressionParser.Parse("name = 'John'");
        Assert.True(result.IsOk);
        Assert.IsType<Comparison<object>>(result.Value);
    }
    ...
    public void ParseAndExpression_shouldWork() {
        Result<BooleanExpression, ErrorCode, Error<ErrorCode>> result = BooleanExpressionParser.Parse("age > 18 and status = 'active'");
        Assert.True(result.IsOk);
    ...
    public void ParseOrExpression_shouldWork() {
        Result<BooleanExpression, ErrorCode, Error<ErrorCode>> result = BooleanExpressionParser.Parse("age > 18 or status = 'active'");
        Assert.True(result.IsOk);
    ...
    public void ParseNotExpression_shouldWork() {
        Result<BooleanExpression, ErrorCode, Error<ErrorCode>> result = BooleanExpressionParser.Parse("not age > 18");
        Assert.True(result.IsOk);
    ...
    public void ParseInExpression_shouldWork() {
        Result<BooleanExpression, ErrorCode, Error<ErrorCode>> result = BooleanExpressionParser.Parse("status in ('active', 'pending')");
        Assert.True(result.IsOk);
    ...
    public void ParseNotInExpression_shouldWork() {
        Result<BooleanExpression, ErrorCode, Error<ErrorCode>> result = BooleanExpressionParser.Parse("status not in ('deleted')");
        Assert.True(result.IsOk);
        Assert.IsType<InExpression<object>>(result.Value);
    }
    ...
    public void ParseIsNull_shouldWork() {
        Result<BooleanExpression, ErrorCode, Error<ErrorCode>> result = BooleanExpressionParser.Parse("email is null");
        Assert.True(result.IsOk);
    ...
    public void ParseIsNotNull_shouldWork() {
        Result<BooleanExpression, ErrorCode, Error<ErrorCode>> result = BooleanExpressionParser.Parse("email is not null");
        Assert.True(result.IsOk);
        Assert.IsType<NullCheck>(result.Value);
    }
    ...
    public void ParseLikeExpression_shouldWork() {
        Result<BooleanExpression, ErrorCode, Error<ErrorCode>> result = BooleanExpressionParser.Parse("name like 'John%'");
        Assert.True(result.IsOk);
    ...
    public void ParseComplexExpression_shouldWork() {
        Result<BooleanExpression, ErrorCode, Error<ErrorCode>> result = BooleanExpressionParser.Parse("(age > 18 and status = 'active') or role = 'admin'");
        Assert.True(result.IsOk);
        Assert.IsType<OrExpression>(result.Value);
    }
    ...
    public void OperatorPrecedence_andBeforeOr() {
        Result<BooleanExpression, ErrorCode, Error<ErrorCode>> result = BooleanExpressionParser.Parse("a > 1 or b < 2 and c = 3");
        Assert.True(result.IsOk);
    ...
    public void ParseFlattenedAnd_shouldMerge() {
        Result<BooleanExpression, ErrorCode, Error<ErrorCode>> result = BooleanExpressionParser.Parse("a > 1 and b < 2 and c = 3");
        Assert.True(result.IsOk);
        Assert.IsType<AndExpression>(result.Value);
...
public class ErrorHandlingTests {
    ...
    public void ParseInvalid_shouldReturnFailed() {
        Result<BooleanExpression, ErrorCode, Error<ErrorCode>> result = BooleanExpressionParser.Parse(">>>");
    ...
    [Fact]
    public void ParseOrNull_shouldReturnExpressionOnSuccess() => Assert.NotNull(BooleanExpressionParser.ParseOrNull("age > 18"));
}

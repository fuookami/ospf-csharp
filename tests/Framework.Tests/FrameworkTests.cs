...
namespace Fuookami.Ospf.Framework.Tests
{
    ...
    public class FrameworkSolveOptionsTests
    {
        ...
        {
            var options = new FrameworkSolveOptions.Builder().Build();
        ...
        {
            var options = new FrameworkSolveOptions.Builder
            {
                Name = "test-solve",
                ToLogModel = true,
                SolutionAmount = 10,
        ...
        {
            var options = new FrameworkSolveOptions.Builder { Name = "custom" }.Build();
        ...
        public void ToCoreSolveOptions_MapsFields()
        {
            ...
            var core = options.ToCoreSolveOptions();
    ...
    public class LogContextTests
    {
        ...
        [Fact]
        public void LogContextScope_AsyncLocal_Flows()
        {
        ...
        [Fact]
        public void LogContextScope_DifferentAsyncContexts_AreIndependent()
        {
        ...
        public void Push_WithNullPushing_DoesNotThrow()
        {
            ...
            var action = () => ctx.Push("step1", new { Data = "test" });
        ...
        {
            var ctx = LogContext.Create(app: "test", version: "1.0", requestId: "r1");
            var action = () => ctx.Save("step1", new { Data = "test" });
            action.Should().NotThrow();
        }
    ...
    public class PipelineTests
    {
        ...
        public void PipelineListInvoker_Invoke_AllSucceed()
        {
            ...
            var result = PipelineListInvoker.Invoke(pipelines, "model");
            result.Should().BeOfType<Ok<Success, ErrorCode, Error<ErrorCode>>>();
        }
    ...
    public class CGPipelineTests
    {
        ...
        public void CGPipeline_Refresh_WithShadowPriceKey()
        {
            ...
            var dualSolution = MetaDualSolution.Empty;

...
using Fuookami.Ospf.Example.CoreDemo.Demo5;
using Fuookami.Ospf.Utils.Error;
using Fuookami.Ospf.Utils.Functional;
using Xunit;

namespace Fuookami.Ospf.Example.Tests.CoreDemo.Demo5;

public class Demo5CoreTests {
    [Fact]
    ...
    public void Model_ShouldHaveCorrectName() {
        ...
        // Assert
        demo.MetaModel.Name.Should().Be("coredemo5-knapsack");
    }

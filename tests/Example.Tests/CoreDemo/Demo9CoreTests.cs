...
using Fuookami.Ospf.Example.CoreDemo.Demo9;
using Fuookami.Ospf.Utils.Error;
using Fuookami.Ospf.Utils.Functional;
using Xunit;

namespace Fuookami.Ospf.Example.Tests.CoreDemo.Demo9;

public class Demo9CoreTests {
    [Fact]
    public void BuildModel_ShouldSucceed() {
        // Arrange
        var demo = new FacilityLocationDemo();
    ...
    public void Model_ShouldHaveCorrectName() {
        ...
        // Assert
        demo.MetaModel.Name.Should().Be("demo9-facility-location");
    }

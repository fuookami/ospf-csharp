...
using Fuookami.Ospf.Example.CoreDemo.Demo12;
using Fuookami.Ospf.Utils.Error;
using Fuookami.Ospf.Utils.Functional;
using Xunit;

namespace Fuookami.Ospf.Example.Tests.CoreDemo.Demo12;

public class Demo12CoreTests {
    [Fact]
    public void BuildModel_ShouldSucceed() {
        // Arrange
        var demo = new InvestmentPortfolioDemo();
    ...
    public void Model_ShouldHaveCorrectName() {
        ...
        // Assert
        demo.MetaModel.Name.Should().Be("demo12-investment-portfolio");
    }

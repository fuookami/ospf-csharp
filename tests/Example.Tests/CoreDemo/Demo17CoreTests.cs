...
using Fuookami.Ospf.Example.CoreDemo.Demo17;
using Fuookami.Ospf.Utils.Error;
using Fuookami.Ospf.Utils.Functional;
using Xunit;

namespace Fuookami.Ospf.Example.Tests.CoreDemo.Demo17;

public class Demo17CoreTests {
    [Fact]
    public void BuildModel_ShouldSucceed() {
        // Arrange
        var demo = new VrptwDemo();
    ...
    public void Model_ShouldHaveCorrectName() {
        ...
        // Assert
        demo.MetaModel.Name.Should().Be("coredemo17-vrptw");
    }

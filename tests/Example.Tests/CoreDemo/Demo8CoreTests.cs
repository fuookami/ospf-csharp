...
using Fuookami.Ospf.Example.CoreDemo.Demo8;
using Fuookami.Ospf.Utils.Error;
using Fuookami.Ospf.Utils.Functional;
using Xunit;

namespace Fuookami.Ospf.Example.Tests.CoreDemo.Demo8;

public class Demo8CoreTests {
    [Fact]
    public void BuildModel_ShouldSucceed() {
        // Arrange
        var demo = new ProductionSchedulingDemo();
    ...
    public void Model_ShouldHaveCorrectName() {
        ...
        // Assert
        demo.MetaModel.Name.Should().Be("demo8-production-scheduling");
    }

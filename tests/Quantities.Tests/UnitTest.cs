...
namespace Fuookami.Ospf.Quantities.Tests
{
    public class UnitTest
    {
        ...
        {
            // 1 km = 1000 m
            var kmToM = LengthUnits.Kilometer.To(SIBaseUnits.Meter);
        ...
        {
            var mPerS = SIBaseUnits.Meter.Divide(SIBaseUnits.Second);
        ...
        {
            var m2 = SIBaseUnits.Meter.Pow(2);
            Assert.NotNull(m2);
        }
        ...
        {
            var result = SIBaseUnits.Meter.To(SIBaseUnits.Second);
            Assert.Null(result);
        }

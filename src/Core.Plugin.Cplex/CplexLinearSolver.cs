...
/// </summary>
public sealed class CplexLinearSolver : ILinearSolver {
    public string Name => "cplex";
    public SolverConfig Config { get; }

    public CplexLinearSolver(SolverConfig? config = null) {
    ...
    public Task<LinearTriadModel> DumpAsync(LinearMechanismModel<Flt64> model, CancellationToken cancellationToken = default) => throw new System.NotSupportedException("Dump not supported by CplexLinearSolver");

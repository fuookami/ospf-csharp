...
/// <summary>
/// COPT 二次求解器（桩实现） / COPT quadratic solver (structural stub).
...
/// </summary>
public sealed class CoptQuadraticSolver : IQuadraticSolver {
    ...
    public CoptQuadraticSolver(SolverConfig? config = null) {
    ...
    public Task<QuadraticTetradModel> DumpAsync(QuadraticMechanismModel<Flt64> model, CancellationToken cancellationToken = default)
        => throw new System.NotSupportedException("Dump not supported by CoptQuadraticSolver");

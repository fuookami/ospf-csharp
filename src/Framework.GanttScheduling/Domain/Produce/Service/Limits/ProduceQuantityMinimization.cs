...
public sealed class ProduceQuantityMinimization<P> : IPipeline<object>
    where P : IMaterial {
    ...
    /// <summary>
    /// 生产数量最小化构造 / Produce quantity minimization constructor
    /// </summary>

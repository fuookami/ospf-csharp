...
public sealed class ConsumptionQuantityMinimization<C> : IPipeline<object>
    where C : IMaterial {
    ...
    /// <summary>
    /// 消费数量最小化构造 / Consumption quantity minimization constructor
    /// </summary>

...
/// </summary>
public class PlanCapacitySchedulingResourceUsage<R, C, V>
    ...
    public PlanCapacitySchedulingResourceUsage(TimeWindow<V> timeWindow, IReadOnlyList<R> resources) {
        _name = "plan_capacity_scheduling_resource";

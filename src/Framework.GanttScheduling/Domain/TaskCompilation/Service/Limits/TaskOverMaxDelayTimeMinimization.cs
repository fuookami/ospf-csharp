...
/// <summary>
/// 任务超过最大延迟时间最小化 / Task over-max delay time minimization
/// </summary>
...
public class TaskOverMaxDelayTimeMinimization<T, E, A>
    ...
    /// <summary>
    /// 任务超过最大延迟时间最小化构造 / Task over-max delay time minimization constructor
    /// </summary>
    ...
    public TaskOverMaxDelayTimeMinimization(
        TimeWindow<Flt64> timeWindow,
        IReadOnlyList<T> tasks,
        TaskTime taskTime,
        string name = "task_over_max_delay_time_minimization") {

...
public class TaskDelayLastEndTimeMinimization<T, E, A>
    ...
    /// <summary>
    /// 任务延迟最晚结束时间最小化构造 / Task delay last-end-time minimization constructor
    /// </summary>
    ...
    public TaskDelayLastEndTimeMinimization(
        TimeWindow<Flt64> timeWindow,
        IReadOnlyList<T> tasks,
        TaskTime taskTime,
        string name = "task_delay_last_end_time_minimization") {

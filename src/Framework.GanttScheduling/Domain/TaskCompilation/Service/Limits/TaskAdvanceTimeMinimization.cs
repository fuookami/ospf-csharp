...
public class TaskAdvanceTimeMinimization<T, E, A>
    ...
    /// <summary>
    /// 任务提前时间最小化构造 / Task advance time minimization constructor
    /// </summary>
    ...
    public TaskAdvanceTimeMinimization(
        TimeWindow<Flt64> timeWindow,
        IReadOnlyList<T> tasks,
        TaskTime taskTime,
        string name = "task_advance_time_minimization") {

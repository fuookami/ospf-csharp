...
namespace Fuookami.Ospf.Core.Plugin.Heuristic.Soa
{
    /// <summary>
    /// 海鸥优化算法 / Seagull Optimization Algorithm. Not implemented yet.
    /// </summary>
    public sealed class SeagullOptimizationAlgorithm<Obj, ObjValue, V> : HeuristicAlgorithm<Obj, ObjValue, V>
            ...
            CancellationToken cancellationToken = default)
        {
            return Task.FromResult(
                Results.Failed<List<IIndividual<ObjValue, V>>>(
                    new Err<ErrorCode>(ErrorCode.ApplicationError, "SeagullOptimizationAlgorithm is not implemented yet.")));
        }
    }
}

        ...
        : HeuristicAlgorithm<Flt64, Flt64, Flt64>
    {
            ...
            CancellationToken cancellationToken = default)
        {
            return await Task.Run(() =>
            {
                ...
                var initialSolutions = model.InitialSolutions((ulong)Policy.ParticleCount);
                ...
                foreach (var p in particles.Skip(1))
                {
                ...
                try
                {
                    ...
                    while (!cancellationToken.IsCancellationRequested)
                    {
                        ...
                        {
                            var (newVel, newPos) = Policy.Accelerate(
                                iteration,
                                p.Velocity,
                                p.Solution,
                                p.PersonalBest,
                            ...
                            var newObj = model.Objective(newPos)!;

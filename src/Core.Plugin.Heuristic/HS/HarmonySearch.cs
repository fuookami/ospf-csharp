...
namespace Fuookami.Ospf.Core.Plugin.Heuristic.Hs;
/// <summary>
/// 和声搜索 / Harmony Search. Not implemented yet.
/// </summary>
public sealed class HarmonySearch<Obj, ObjValue, V> : HeuristicAlgorithm<Obj, ObjValue, V>
    ...
    public override Task<Result<List<IIndividual<ObjValue, V>>, ErrorCode, Error<ErrorCode>>> InvokeAsync(
        ...
        return Task.FromResult(
            Results.Failed<List<IIndividual<ObjValue, V>>>(
                new Err<ErrorCode>(ErrorCode.ApplicationError, "HarmonySearch is not implemented yet.")));
    }
}

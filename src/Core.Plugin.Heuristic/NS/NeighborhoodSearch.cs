...
namespace Fuookami.Ospf.Core.Plugin.Heuristic.Ns
{
    /// <summary>
    /// 邻域搜索 / Neighborhood Search. Not implemented yet.
    /// </summary>
    public sealed class NeighborhoodSearch<Obj, ObjValue, V> : HeuristicAlgorithm<Obj, ObjValue, V>
            ...
            CancellationToken cancellationToken = default)
        {
            return Task.FromResult(
                Results.Failed<List<IIndividual<ObjValue, V>>>(
                    new Err<ErrorCode>(ErrorCode.ApplicationError, "NeighborhoodSearch is not implemented yet.")));
        }
    }
}

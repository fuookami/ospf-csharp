...
namespace Fuookami.Ospf.Core.Plugin.Heuristic.Warso
{
    /// <summary>
    /// 战争策略优化算法 / War Strategy Optimization Algorithm. Not implemented yet.
    /// </summary>
    public sealed class WarStrategyOptimizationAlgorithm<Obj, ObjValue, V> : HeuristicAlgorithm<Obj, ObjValue, V>
            ...
            CancellationToken cancellationToken = default)
        {
            return Task.FromResult(
                Results.Failed<List<IIndividual<ObjValue, V>>>(
                    new Err<ErrorCode>(ErrorCode.ApplicationError, "WarStrategyOptimizationAlgorithm is not implemented yet.")));
        }
    }
}

...
/// <summary>
/// 两符号相等函数 / Symbol equality function
/// </summary>
public sealed class SameAsFunction : IMathFunctionSymbol<Flt64> {
    public string Name { get; set; }
    public string? DisplayName { get; set; }
    public IReadOnlyList<IVariableItem> HelperVariables => Array.Empty<IVariableItem>();

    public SameAsFunction(string name = "sameAs", string? displayName = null) {
        Name = name;

...
/// <summary>
/// 二次掩码区间函数 / Quadratic masking range function
/// </summary>
public sealed class QuadraticMaskingRangeFunction : IMathFunctionSymbol<Flt64> {
    public string Name { get; set; }
    public string? DisplayName { get; set; }
    public IReadOnlyList<IVariableItem> HelperVariables => Array.Empty<IVariableItem>();

    public QuadraticMaskingRangeFunction(string name = "quadraticMaskingRange", string? displayName = null) {
        Name = name;

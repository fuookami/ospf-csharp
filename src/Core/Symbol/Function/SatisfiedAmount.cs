...
/// <summary>
/// 满足数量计数函数 / Satisfied amount counting function
/// </summary>
public sealed class SatisfiedAmountFunction : IMathFunctionSymbol<Flt64>
{
    public string Name { get; set; }
    public string? DisplayName { get; set; }
    public IReadOnlyList<IVariableItem> HelperVariables => Array.Empty<IVariableItem>();

    public SatisfiedAmountFunction(string name = "satisfiedAmount", string? displayName = null)
    {
        Name = name;

...
/// <summary>
/// 二值化函数 (0/1) / Binaryzation function mapping to 0 or 1
/// </summary>
public sealed class BinaryzationFunction : IMathFunctionSymbol<Flt64> {
    public string Name { get; set; }
    public string? DisplayName { get; set; }
    public IReadOnlyList<IVariableItem> HelperVariables => Array.Empty<IVariableItem>();

    public BinaryzationFunction(string name = "binaryzation", string? displayName = null) {
        Name = name;

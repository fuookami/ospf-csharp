...
/// <summary>
/// If-then 蕴含函数 / If-then implication function
/// </summary>
public sealed class IfThenFunction : IMathFunctionSymbol<Flt64>
{
    public string Name { get; set; }
    public string? DisplayName { get; set; }
    public IReadOnlyList<IVariableItem> HelperVariables => Array.Empty<IVariableItem>();

    public IfThenFunction(string name = "ifThen", string? displayName = null)
    {
        Name = name;

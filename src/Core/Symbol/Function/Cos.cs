...
/// <summary>
/// 余弦近似函数 / Cosine approximation function
/// </summary>
public sealed class CosFunction : IMathFunctionSymbol<Flt64>
{
    public string Name { get; set; }
    public string? DisplayName { get; set; }
    public IReadOnlyList<IVariableItem> HelperVariables => Array.Empty<IVariableItem>();

    public CosFunction(string name = "cos", string? displayName = null)
    {
        Name = name;

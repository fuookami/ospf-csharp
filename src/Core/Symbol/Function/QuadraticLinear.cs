...
/// <summary>
/// 二次线性函数 / Quadratic linear function
/// </summary>
public sealed class QuadraticLinearFunction : IMathFunctionSymbol<Flt64>
{
    public string Name { get; set; }
    public string? DisplayName { get; set; }
    public IReadOnlyList<IVariableItem> HelperVariables => Array.Empty<IVariableItem>();

    public QuadraticLinearFunction(string name = "quadraticLinear", string? displayName = null)
    {
        Name = name;

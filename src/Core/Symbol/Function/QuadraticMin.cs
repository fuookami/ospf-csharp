...
/// <summary>
/// 二次最小值函数 / Quadratic minimum function
/// </summary>
public sealed class QuadraticMinFunction : IMathFunctionSymbol<Flt64>
{
    public string Name { get; set; }
    public string? DisplayName { get; set; }
    public IReadOnlyList<IVariableItem> HelperVariables => Array.Empty<IVariableItem>();

    public QuadraticMinFunction(string name = "quadraticMin", string? displayName = null)
    {
        Name = name;

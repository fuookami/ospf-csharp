...
/// <summary>
/// 平衡三进制化函数 / Balanced ternaryzation function
/// </summary>
public sealed class BalanceTernaryzationFunction : IMathFunctionSymbol<Flt64> {
    public string Name { get; set; }
    public string? DisplayName { get; set; }
    public IReadOnlyList<IVariableItem> HelperVariables => Array.Empty<IVariableItem>();

    public BalanceTernaryzationFunction(string name = "balanceTernaryzation", string? displayName = null) {
        Name = name;

...
/// <summary>
/// 松弛区间函数 / Slack range function
/// </summary>
public sealed class SlackRangeFunction : IMathFunctionSymbol<Flt64> {
    public string Name { get; set; }
    public string? DisplayName { get; set; }
    public IReadOnlyList<IVariableItem> HelperVariables => Array.Empty<IVariableItem>();

    public SlackRangeFunction(string name = "slackRange", string? displayName = null) {
        Name = name;

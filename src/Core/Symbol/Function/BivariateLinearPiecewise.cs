...
/// <summary>
/// 双变量线性分段函数 / Bivariate linear piecewise function
/// </summary>
public sealed class BivariateLinearPiecewiseFunction : IMathFunctionSymbol<Flt64>
{
    public string Name { get; set; }
    public string? DisplayName { get; set; }
    public IReadOnlyList<IVariableItem> HelperVariables => Array.Empty<IVariableItem>();

    public BivariateLinearPiecewiseFunction(string name = "bivariateLinearPiecewise", string? displayName = null)
    {
        Name = name;

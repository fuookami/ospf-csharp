...
/// <summary>
/// 不等式编码函数 / Inequality encoding function
/// </summary>
public sealed class InequalityFunction : IMathFunctionSymbol<Flt64> {
    public string Name { get; set; }
    public string? DisplayName { get; set; }
    public IReadOnlyList<IVariableItem> HelperVariables => Array.Empty<IVariableItem>();

    public InequalityFunction(string name = "inequality", string? displayName = null) {
        Name = name;

...
/// <summary>
/// 符号乘积函数 / Symbol product function
/// </summary>
public sealed class ProductFunction : IMathFunctionSymbol<Flt64> {
    public string Name { get; set; }
    public string? DisplayName { get; set; }
    public IReadOnlyList<IVariableItem> HelperVariables => Array.Empty<IVariableItem>();

    public ProductFunction(string name = "product", string? displayName = null) {
        Name = name;

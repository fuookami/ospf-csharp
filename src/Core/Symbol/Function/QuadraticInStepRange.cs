...
/// <summary>
/// 二次步长区间归属函数 / Quadratic step range membership function
/// </summary>
public sealed class QuadraticInStepRangeFunction : IMathFunctionSymbol<Flt64> {
    public string Name { get; set; }
    public string? DisplayName { get; set; }
    public IReadOnlyList<IVariableItem> HelperVariables => Array.Empty<IVariableItem>();

    public QuadraticInStepRangeFunction(string name = "quadraticInStepRange", string? displayName = null) {
        Name = name;

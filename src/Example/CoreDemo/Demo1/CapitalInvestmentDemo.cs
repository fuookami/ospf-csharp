...
namespace Fuookami.Ospf.Example.CoreDemo.Demo1;
/// <summary>
/// 公司：具有资本、负债和利润属性。Company with capital, liability, and profit attributes.
/// </summary>
...
public sealed class CapitalInvestmentDemo {
    ...
    private readonly LinearMetaModel<Flt64> _metaModel = new("coredemo1-capital-investment", ObjectCategory.Maximum);

...
public interface IOrderByTranslator<T> where T : class {
    global::System.Linq.Expressions.Expression<Func<T, object>>? Translate(string propertyName, bool ascending = true);
}

public class DefaultOrderByTranslator<T> : IOrderByTranslator<T> where T : class {
    public global::System.Linq.Expressions.Expression<Func<T, object>>? Translate(string propertyName, bool ascending = true) {

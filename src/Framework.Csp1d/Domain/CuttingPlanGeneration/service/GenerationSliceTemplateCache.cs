...
internal sealed class SequentialGenerationSliceTemplateCache<TMaterial, TSlice>
    ...
    public IReadOnlyList<IReadOnlyList<TSlice>>? Get(
        ...
        System.Action? cacheHitAction = null,
        System.Action? cacheMissAction = null) {
        if (_cache.TryGetValue(material, out IReadOnlyList<IReadOnlyList<TSlice>>? templates)) {
    ...
    /// <inheritdoc/>
    public void Put(TMaterial material, IReadOnlyList<IReadOnlyList<TSlice>> templates) => _cache.TryAdd(material, templates);
}

...
namespace Fuookami.Ospf.Math.Algebra.ValueRange
{
        ...
        where TUpper : IntervalKind
    {
        ...
        {
            var r = ValueRange<T>.Of(lb, ub, lowerKind.Interval, upperKind.Interval);
        ...
        public static Result<TypedValueRange<T, IntervalKind.ClosedIntervalKind, IntervalKind.ClosedIntervalKind>, ErrorCode, Error<ErrorCode>> Closed(T lb, T ub)
        {
            ...
            var r = ValueRange<T>.Of(lb, ub, lk.Interval, uk.Interval);
        ...
        private static bool IsPositive(T v) { var zero = v.Minus(v); return v.Gr(zero); }
        private static bool IsNegative(T v) { var zero = v.Minus(v); return v.Ls(zero); }
